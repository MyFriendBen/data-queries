...
WITH base AS (
    SELECT
        ...
        sum(CASE WHEN co_energy_calculator_bheap_annual > 0 THEN 1 ELSE 0 END) AS co_bheap,
        sum(CASE WHEN co_energy_calculator_bhgap_annual > 0 THEN 1 ELSE 0 END) AS co_bhgap,
        sum(CASE WHEN co_energy_calculator_care_annual > 0 THEN 1 ELSE 0 END) AS co_care,
        sum(CASE WHEN co_energy_calculator_cngba_annual > 0 THEN 1 ELSE 0 END) AS co_cngba,
        sum(CASE WHEN co_energy_calculator_cowap_annual > 0 THEN 1 ELSE 0 END) AS co_wap_energy,
        sum(CASE WHEN co_energy_calculator_cpcr_annual > 0 THEN 1 ELSE 0 END) AS co_cpcr_energy,
        sum(CASE WHEN co_energy_calculator_ea_annual > 0 THEN 1 ELSE 0 END) AS co_ea,
        sum(CASE WHEN co_energy_calculator_energy_ebt_annual > 0 THEN 1 ELSE 0 END) AS co_energy_ebt,
        sum(CASE WHEN co_energy_calculator_eoc_annual > 0 THEN 1 ELSE 0 END) AS co_eoc,
        sum(CASE WHEN co_energy_calculator_eoccip_annual > 0 THEN 1 ELSE 0 END) AS co_eoccip,
        sum(CASE WHEN co_energy_calculator_eocs_annual > 0 THEN 1 ELSE 0 END) AS co_eocs,
        sum(CASE WHEN co_energy_calculator_leap_annual > 0 THEN 1 ELSE 0 END) AS co_leap_energy,
        sum(CASE WHEN co_energy_calculator_poipp_annual > 0 THEN 1 ELSE 0 END) AS co_poipp,
        sum(CASE WHEN co_energy_calculator_ubp_annual > 0 THEN 1 ELSE 0 END) AS co_ubp_energy,
