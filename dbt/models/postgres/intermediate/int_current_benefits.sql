...
SELECT
    ...
    sum(CASE WHEN cesn_bheap_annual > 0 THEN 1 ELSE 0 END) AS cesn_bheap,
    sum(CASE WHEN cesn_bhgap_annual > 0 THEN 1 ELSE 0 END) AS cesn_bhgap,
    sum(CASE WHEN cesn_care_annual > 0 THEN 1 ELSE 0 END) AS cesn_care,
    sum(CASE WHEN cesn_cngba_annual > 0 THEN 1 ELSE 0 END) AS cesn_cngba,
    sum(CASE WHEN cesn_cpcr_annual > 0 THEN 1 ELSE 0 END) AS cesn_cpcr,
    sum(CASE WHEN cesn_ea_annual > 0 THEN 1 ELSE 0 END) AS cesn_ea,
    sum(CASE WHEN cesn_energy_ebt_annual > 0 THEN 1 ELSE 0 END) AS cesn_ebt,
    sum(CASE WHEN cesn_eoc_annual > 0 THEN 1 ELSE 0 END) AS cesn_eoc,
    sum(CASE WHEN cesn_eoccip_annual > 0 THEN 1 ELSE 0 END) AS cesn_eoccip,
    sum(CASE WHEN cesn_eocs_annual > 0 THEN 1 ELSE 0 END) AS cesn_eocs,
    sum(CASE WHEN cesn_leap_annual > 0 THEN 1 ELSE 0 END) AS cesn_leap,
    sum(CASE WHEN cesn_poipp_annual > 0 THEN 1 ELSE 0 END) AS cesn_poipp,
    sum(CASE WHEN cesn_ubp_annual > 0 THEN 1 ELSE 0 END) AS cesn_ubp,
    sum(CASE WHEN cesn_xceleap_annual > 0 THEN 1 ELSE 0 END) AS cesn_xceleap,
    sum(CASE WHEN cesn_xcelgap_annual > 0 THEN 1 ELSE 0 END) AS cesn_xcelgap,
