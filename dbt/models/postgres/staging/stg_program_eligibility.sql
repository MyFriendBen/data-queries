...
SELECT
    ...
    sum(CASE WHEN name_abbreviated = 'cesn_bheap' THEN estimated_value ELSE 0 END)
        AS cesn_bheap_annual,
    sum(CASE WHEN name_abbreviated = 'cesn_bhgap' THEN estimated_value ELSE 0 END)
        AS cesn_bhgap_annual,
    sum(CASE WHEN name_abbreviated = 'cesn_care' THEN estimated_value ELSE 0 END)
        AS cesn_care_annual,
    sum(CASE WHEN name_abbreviated = 'cesn_cngba' THEN estimated_value ELSE 0 END)
        AS cesn_cngba_annual,
    sum(CASE WHEN name_abbreviated = 'cesn_cowap' THEN estimated_value ELSE 0 END)
        AS cesn_cowap_annual,
    sum(CASE WHEN name_abbreviated = 'cesn_cpcr' THEN estimated_value ELSE 0 END)
        AS cesn_cpcr_annual,
    sum(CASE WHEN name_abbreviated = 'cesn_ea' THEN estimated_value ELSE 0 END)
        AS cesn_ea_annual,
    sum(CASE WHEN name_abbreviated = 'cesn_energy_ebt' THEN estimated_value ELSE 0 END)
        AS cesn_energy_ebt_annual,
    sum(CASE WHEN name_abbreviated = 'cesn_eoc' THEN estimated_value ELSE 0 END)
        AS cesn_eoc_annual,
    sum(CASE WHEN name_abbreviated = 'cesn_eoccip' THEN estimated_value ELSE 0 END)
        AS cesn_eoccip_annual,
    sum(CASE WHEN name_abbreviated = 'cesn_eocs' THEN estimated_value ELSE 0 END)
        AS cesn_eocs_annual,
    sum(CASE WHEN name_abbreviated = 'cesn_leap' THEN estimated_value ELSE 0 END)
        AS cesn_leap_annual,
    sum(CASE WHEN name_abbreviated = 'cesn_poipp' THEN estimated_value ELSE 0 END)
        AS cesn_poipp_annual,
    sum(CASE WHEN name_abbreviated = 'cesn_ubp' THEN estimated_value ELSE 0 END)
        AS cesn_ubp_annual,
    sum(CASE WHEN name_abbreviated = 'cesn_xceleap' THEN estimated_value ELSE 0 END)
        AS cesn_xceleap_annual,
    sum(CASE WHEN name_abbreviated = 'cesn_xcelgap' THEN estimated_value ELSE 0 END)
        AS cesn_xcelgap_annual,
    ...
    -- CESN energy assistance programs
    sum(CASE WHEN name_abbreviated = 'cesn_bheap' THEN estimated_value ELSE 0 END) AS cesn_bheap_annual,
    sum(CASE WHEN name_abbreviated = 'cesn_bhgap' THEN estimated_value ELSE 0 END) AS cesn_bhgap_annual,
    sum(CASE WHEN name_abbreviated = 'cesn_care' THEN estimated_value ELSE 0 END) AS cesn_care_annual,
    sum(CASE WHEN name_abbreviated = 'cesn_cngba' THEN estimated_value ELSE 0 END) AS cesn_cngba_annual,
    sum(CASE WHEN name_abbreviated = 'cesn_cope' THEN estimated_value ELSE 0 END) AS cesn_cope_annual,
    sum(CASE WHEN name_abbreviated = 'cesn_cowap' THEN estimated_value ELSE 0 END) AS cesn_cowap_annual,
    sum(CASE WHEN name_abbreviated = 'cesn_cpcr' THEN estimated_value ELSE 0 END) AS cesn_cpcr_annual,
    sum(CASE WHEN name_abbreviated = 'cesn_ea' THEN estimated_value ELSE 0 END) AS cesn_ea_annual,
    sum(CASE WHEN name_abbreviated = 'cesn_energy_ebt' THEN estimated_value ELSE 0 END) AS cesn_energy_ebt_annual,
    sum(CASE WHEN name_abbreviated = 'cesn_energy_mep' THEN estimated_value ELSE 0 END) AS cesn_energy_mep_annual,
    sum(CASE WHEN name_abbreviated = 'cesn_energy_vec' THEN estimated_value ELSE 0 END) AS cesn_energy_vec_annual,
    sum(CASE WHEN name_abbreviated = 'cesn_eoc' THEN estimated_value ELSE 0 END) AS cesn_eoc_annual,
    sum(CASE WHEN name_abbreviated = 'cesn_eoccip' THEN estimated_value ELSE 0 END) AS cesn_eoccip_annual,
    sum(CASE WHEN name_abbreviated = 'cesn_eocs' THEN estimated_value ELSE 0 END) AS cesn_eocs_annual,
    sum(CASE WHEN name_abbreviated = 'cesn_heap' THEN estimated_value ELSE 0 END) AS cesn_heap_annual,
    sum(CASE WHEN name_abbreviated = 'cesn_ilp' THEN estimated_value ELSE 0 END) AS cesn_ilp_annual,
    sum(CASE WHEN name_abbreviated = 'cesn_lccc' THEN estimated_value ELSE 0 END) AS cesn_lccc_annual,
    sum(CASE WHEN name_abbreviated = 'cesn_leap' THEN estimated_value ELSE 0 END) AS cesn_leap_annual,
    sum(CASE WHEN name_abbreviated = 'cesn_mcp' THEN estimated_value ELSE 0 END) AS cesn_mcp_annual,
