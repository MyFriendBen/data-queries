    ...
    for k, v in var.tenants : k => flatten(concat(
      ...
      [{
        ...
        parameter_mappings = concat(
          ...
          local.tenant_features[k].has_utm_filters ? [
            { parameter_id = "utm_campaign_filter", card_id = tonumber(metabase_card.tenant_already_had_benefits_pct[k].id), target = ["dimension", ["template-tag", "utm_campaign"]] },
            { parameter_id = "utm_medium_filter", card_id = tonumber(metabase_card.tenant_already_had_benefits_pct[k].id), target = ["dimension", ["template-tag", "utm_medium"]] },
            { parameter_id = "utm_source_filter", card_id = tonumber(metabase_card.tenant_already_had_benefits_pct[k].id), target = ["dimension", ["template-tag", "utm_source"]] }
          ] : []
        )
        series                 = []
        visualization_settings = {}
      ...
      [{
        ...
        parameter_mappings = concat(
          ...
          local.tenant_features[k].has_utm_filters ? [
            { parameter_id = "utm_campaign_filter", card_id = tonumber(metabase_card.tenant_qualified_for_benefits_pct[k].id), target = ["dimension", ["template-tag", "utm_campaign"]] },
            { parameter_id = "utm_medium_filter", card_id = tonumber(metabase_card.tenant_qualified_for_benefits_pct[k].id), target = ["dimension", ["template-tag", "utm_medium"]] },
            { parameter_id = "utm_source_filter", card_id = tonumber(metabase_card.tenant_qualified_for_benefits_pct[k].id), target = ["dimension", ["template-tag", "utm_source"]] }
          ] : []
        )
        series                 = []
        visualization_settings = {}
      ...
      local.tenant_features[k].has_tax_credits ? [{
        ...
        parameter_mappings = concat(
          ...
          local.tenant_features[k].has_utm_filters ? [
            { parameter_id = "utm_campaign_filter", card_id = tonumber(metabase_card.tenant_qualified_for_tax_creds_pct[k].id), target = ["dimension", ["template-tag", "utm_campaign"]] },
            { parameter_id = "utm_medium_filter", card_id = tonumber(metabase_card.tenant_qualified_for_tax_creds_pct[k].id), target = ["dimension", ["template-tag", "utm_medium"]] },
            { parameter_id = "utm_source_filter", card_id = tonumber(metabase_card.tenant_qualified_for_tax_creds_pct[k].id), target = ["dimension", ["template-tag", "utm_source"]] }
          ] : []
        )
        series                 = []
        visualization_settings = {}
      ...
      [{
        ...
        parameter_mappings = concat(
          ...
          local.tenant_features[k].has_utm_filters ? [
            { parameter_id = "utm_campaign_filter", card_id = tonumber(metabase_card.tenant_current_benefits_table[k].id), target = ["dimension", ["template-tag", "utm_campaign"]] },
            { parameter_id = "utm_medium_filter", card_id = tonumber(metabase_card.tenant_current_benefits_table[k].id), target = ["dimension", ["template-tag", "utm_medium"]] },
            { parameter_id = "utm_source_filter", card_id = tonumber(metabase_card.tenant_current_benefits_table[k].id), target = ["dimension", ["template-tag", "utm_source"]] }
          ] : []
        )
        series                 = []
        visualization_settings = {}
      ...
      local.tenant_features[k].has_immediate_needs ? [{
        ...
        parameter_mappings = concat(
          ...
          local.tenant_features[k].has_utm_filters ? [
            { parameter_id = "utm_campaign_filter", card_id = tonumber(metabase_card.tenant_immediate_needs_table[k].id), target = ["dimension", ["template-tag", "utm_campaign"]] },
            { parameter_id = "utm_medium_filter", card_id = tonumber(metabase_card.tenant_immediate_needs_table[k].id), target = ["dimension", ["template-tag", "utm_medium"]] },
            { parameter_id = "utm_source_filter", card_id = tonumber(metabase_card.tenant_immediate_needs_table[k].id), target = ["dimension", ["template-tag", "utm_source"]] }
          ] : []
        )
        series                 = []
        visualization_settings = {}
